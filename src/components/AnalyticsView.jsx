...
const studentsData = [
  { id: 1, name: "Иванов Иван", progress: 85, assignments: 5, totalAssignments: 6, violations: 0 },
  { id: 2, name: "Петров Петр", progress: 60, assignments: 3, totalAssignments: 6, violations: 1 },
  { id: 3, name: "Смирнова Анна", progress: 100, assignments: 6, totalAssignments: 6, violations: 0 },
  { id: 4, name: "Кузнецов Алексей", progress: 30, assignments: 1, totalAssignments: 6, violations: 4 },
  { id: 5, name: "Сидорова Елена", progress: 75, assignments: 4, totalAssignments: 6, violations: 0 },
];

const AnalyticsView = ({ activeClass }) => {
  return (
    <motion.div
              ...
              <tr key={student.id} className={`transition-colors ${student.violations > 2 ? 'bg-red-50/50 hover:bg-red-50' : 'hover:bg-slate-50/50'}`}>
                ...
                <td className="px-6 py-4 text-center">
                  <span className={`py-1 px-3 rounded-full font-semibold text-xs ${
                    student.assignments === student.totalAssignments ? 'bg-emerald-50 text-emerald-700' :
